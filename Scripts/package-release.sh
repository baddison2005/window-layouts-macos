...
OUTPUT_ZIP="$OUTPUT_DIRECTORY/Window-Layouts-$VERSION-macOS.zip"
[[ ! -e "$OUTPUT_ZIP" ]] || {
...
SUBMISSION_ZIP="$WORK_DIRECTORY/Window-Layouts-$VERSION-submission.zip"
...
APP_PATH="$ARCHIVE_PATH/Products/Applications/Window Layouts.app"
[[ -d "$APP_PATH" ]] || { print -u2 "Archive did not contain Window Layouts.app."; exit 1; }
